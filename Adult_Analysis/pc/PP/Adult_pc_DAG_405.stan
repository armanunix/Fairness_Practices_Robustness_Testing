...
m[ind] ~ poisson(exp((agem * age[ind])  +(em * e[ind])  +(om * o[ind])  +(rm * r[ind])  +(racem * race[ind])  +(genderm * gender[ind])  +(hrm * hr[ind])  +(ym * y[ind])  + m0));
w[ind] ~ poisson(exp((ew * e[ind])  +(mw * m[ind])  +(ow * o[ind])  +(rw * r[ind])  +(racew * race[ind])  +(genderw * gender[ind])  +(hrw * hr[ind])  +(yw * y[ind])  + w0));
