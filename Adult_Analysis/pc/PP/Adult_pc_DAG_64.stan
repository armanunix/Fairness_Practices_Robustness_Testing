...
race[ind] ~ poisson(exp((agerace * age[ind])  +(wrace * w[ind])  +(erace * e[ind])  +(orace * o[ind])  +(rrace * r[ind])  +(genderrace * gender[ind])  +(hrrace * hr[ind])  +(nrace * n[ind])  +(yrace * y[ind])  + race0));
