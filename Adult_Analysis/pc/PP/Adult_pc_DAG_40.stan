...
m[ind] ~ poisson(exp((agem * age[ind])  +(wm * w[ind])  +(em * e[ind])  +(om * o[ind])  +(rm * r[ind])  +(genderm * gender[ind])  +(hrm * hr[ind])  +(ym * y[ind])  + m0));
n[ind] ~ poisson(exp((agen * age[ind])  +(wn * w[ind])  +(en * e[ind])  +(mn * m[ind])  +(on * o[ind])  +(gendern * gender[ind])  +(hrn * hr[ind])  +(yn * y[ind])  + n0));
