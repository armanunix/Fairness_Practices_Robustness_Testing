...
for(ind in 1:N){label[ind] ~ bernoulli_logit((mlabel * m[ind])  + label0);
p[ind] ~ poisson(exp((mp * m[ind])  +(labelp * label[ind])  + p0));
o[ind] ~ bernoulli_logit((po * p[ind])  +(labelo * label[ind])  + o0);
n[ind] ~ bernoulli_logit((on * o[ind])  + n0);
k[ind] ~ poisson(exp((mk * m[ind])  +(nk * n[ind])  +(ok * o[ind])  +(pk * p[ind])  +(labelk * label[ind])  + k0));
l[ind] ~ poisson(exp((kl * k[ind])  +(ml * m[ind])  +(nl * n[ind])  +(ol * o[ind])  +(pl * p[ind])  +(labell * label[ind])  + l0));
