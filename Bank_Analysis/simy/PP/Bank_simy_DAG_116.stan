...
for(ind in 1:N){o[ind] ~ bernoulli_logit((no * n[ind])  +(labelo * label[ind])  + o0);
p[ind] ~ poisson(exp((op * o[ind])  +(labelp * label[ind])  + p0));
m[ind] ~ poisson(exp((pm * p[ind])  +(labelm * label[ind])  + m0));
j[ind] ~ poisson(exp((mj * m[ind])  +(nj * n[ind])  +(oj * o[ind])  +(pj * p[ind])  +(labelj * label[ind])  + j0));
l[ind] ~ poisson(exp((jl * j[ind])  +(ml * m[ind])  +(nl * n[ind])  +(ol * o[ind])  +(pl * p[ind])  +(labell * label[ind])  + l0));
